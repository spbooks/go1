...
func HandleImageEdit(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	RenderTemplate(w, r, "images/edit", map[string]interface{}{
		"Image": nil,
	})
}

func HandleImageUpdate(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	RenderTemplate(w, r, "images/edit", map[string]interface{}{
		"Image": nil,
	})
}
